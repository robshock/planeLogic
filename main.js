...
let decisionPoint3 = window.innerHeight * 0.66;
...
function updateDecisionPoints() {
  ...
  decisionPoint5 = window.innerHeight * 0.56;
  decisionPoint6 = window.innerHeight * 0.45;
  decisionPoint7 = window.innerHeight * 0.34;
...
function restartGame() {
  ...
  firstDecisionMadeDarkGreen = false;
  secondDecisionMadeDarkGreen = false;
  thirdDecisionMadeDarkGreen = false;
  fourthDecisionMadeDarkGreen = false;
